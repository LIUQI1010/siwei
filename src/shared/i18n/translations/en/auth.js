...
export const authEn = {
  ...
  USER_NOT_CONFIRMED: "Account not confirmed, please check your email verification code",
  ...
  INVALID_PASSWORD_FORMAT: "Password does not meet requirements, please ensure password is at least 8 characters with lowercase letters and numbers",
  ...
  PHONE_NUMBER_MISSING: "Phone number information is missing, please check input",
  INVALID_PARAMETER: "Invalid parameter",
  SESSION_EXPIRED: "Login session has expired, please login again with temporary password",
  SESSION_INVALID: "Login session is invalid, please login again with temporary password",
